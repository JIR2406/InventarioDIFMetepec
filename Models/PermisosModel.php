...
class PermisosModel extends Mysql
{
	...
	public function updatePermisos(int $id, int $idmodulo, int $r, int $w, int $u, int $d)
	{
		$this->intRolid = $id;
		$this->intModuloid = $idmodulo;
		$this->r = $r;
		...
		$this->u = $u;
		$this->d = $d;
		$query_insert = "UPDATE PERMISOS (r,w,u,d) VALUES(?,?,?,?) where rolid=? and idpermiso=";
		$arrData = array($this->r, $this->w, $this->u, $this->d, $this->intRolid, $this->intModuloid);
