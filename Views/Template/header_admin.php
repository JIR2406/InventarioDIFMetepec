...
<head>
  <meta charset="utf-8">
  <meta name="description" content="InventariosDIFMetepec">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="author" content="Jair Garduño">
...
<div id="divLoading" class="loading-container">
  ...
  <!-- Navbar-->
  <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>dashboard">Sistema Inventario</a>
    <!-- Sidebar toggle button--><a class="app-sidebar__toggle" href="<?=base_url();?>" data-toggle="sidebar"
